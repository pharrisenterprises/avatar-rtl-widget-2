...
export default function AvatarDebug() {
  ...
  return (
    <div style={{ padding: 20, color: '#fff', background: '#111', minHeight: '100vh' }}>
      ...
      <p>{note}</p>
      <button onClick={start} style={{padding:'10px 16px',borderRadius:8,background:'#1e90ff',color:'#fff'}}>Start</button>
      <div style={{ marginTop: 20, width: 640, maxWidth: '100%', aspectRatio: '16/9', background: '#000', borderRadius: 12 }}>
